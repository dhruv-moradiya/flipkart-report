...
export default function PnlReportByIdPage({ params }: PageProps) {
  ...
  useEffect(() => {
    if (reportId && activeReportId !== reportId) {
      loadReportFromBackend(reportId);
    }
  }, [reportId, activeReportId, loadReportFromBackend]);
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {pnlReports.length > 1 && (
              ...
              >
                <SelectTrigger className="h-7 text-xs w-[180px] font-medium bg-background border-border">
